...
export default function Dashboard({ onLogout }) {
  ...
  function uploadCsv(e) {
    ...
    reader.onload = () => {
      ...
      const requirementIndex = headers.findIndex(
        (h) => h.includes("requirement") || h.includes("action")
      );
      ...
      const importedItems = lines.slice(1).map((line) => {
        ...
        const cleanPriority = priorities.includes(priorityValue) ? priorityValue : "Medium";
    ...
    return tender.checklist
      .filter((item) => {
        const matchSearch =
          ...
          String(item.owner || "").toLowerCase().includes(search.toLowerCase());

        const matchCategory = category ? item.category === category : true;
        const matchMandatory = mandatoryOnly
          ...
          >
            <div className="mb-6 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              ...
              <div className="no-print flex flex-wrap gap-2">
                ...
                <button
                  onClick={() => exportTenderCsv(tender)}
                  className="flex items-center gap-2 rounded-xl bg-slate-900 px-4 py-2 text-sm font-bold text-white"
                >
                  <Download size={16} />
                  CSV
                </button>
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl bg-blue-700 px-4 py-2 text-sm font-bold text-white"
                >
                  <Printer size={16} />
                  PDF / Print
                </button>
            ...
            <div className="mb-6 grid gap-4 md:grid-cols-4">
              <Field label="Project Reference">
                <input
                  ...
                  onChange={(e) => updateTender({ reference: e.target.value })}
                />
              </Field>
              ...
              <Field label="Submission Deadline">
                <input
                  ...
                  onChange={(e) => updateTender({ deadline: e.target.value })}
                />
              </Field>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4 backdrop-blur-sm">
          ...
          >
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Detail label="Owner" value={viewItem.owner || "Project Team"} />
              <Detail label="Priority" value={viewItem.priority || "Medium"} />
...
function Stat({ label, value, danger }) {
  return (
    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
      <div className={`text-2xl font-bold ${danger ? "text-red-600" : "text-slate-900"}`}>
        {value}
      </div>
